...
def getWeatherList(html): # 分析天气数据，提取需要的数据
    ...
    for i in range(len(dateList)):
        n1 = name1List[0]+name2List[1] 
        #n2 = name2List[2]   #[<span>&gt;</span>, <span>&gt;</span>, <span>江阴</span>]城市名所在顺序索引为2
        d1 = dateList[i]
        w1 = weaList[i]
        t1 = temList[i]
        wi1 = winList[i]
        wList.append([n1,d1,w1,t1,wi1])
    return wList
...
def main():
    url = 'http://www.weather.com.cn/weather/101010200.shtml'#某地天气
